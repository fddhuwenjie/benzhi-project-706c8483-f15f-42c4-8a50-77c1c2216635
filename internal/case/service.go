...
type Service struct {
	...
	executionSummaryMu    sync.Mutex
	executionSummaryCache map[string]ExecutionSummary
}

func NewService(repository Repository) *Service {
	return &Service{repository: repository, now: func() time.Time { return time.Now().UTC() }, id: randomID, executionSummaryCache: make(map[string]ExecutionSummary)}
}
