...
type Service struct {
	...
	followUpCache map[string]FollowUpView
}

func NewService(repository Repository) *Service {
	return &Service{repository: repository, now: func() time.Time { return time.Now().UTC() }, id: randomID, followUpCache: make(map[string]FollowUpView)}
}
