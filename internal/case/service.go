...
type Service struct {
	...
	recoveryProgressMu    sync.Mutex
	recoveryProgressCache map[recoveryProgressCacheKey]RecoveryProgressView
}
...
func NewService(repository Repository) *Service {
	return &Service{
		...
		id:                    randomID,
		recoveryProgressCache: make(map[recoveryProgressCacheKey]RecoveryProgressView),
	}
}
