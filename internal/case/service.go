...
type Service struct {
	...
	inspectionReportMu    sync.Mutex
	inspectionReportCache map[string]inspectionReportCacheEntry
}
...
func NewService(repository Repository) *Service {
	return &Service{
		...
		id:                    randomID,
		inspectionReportCache: make(map[string]inspectionReportCacheEntry),
	}
}
