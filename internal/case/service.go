...
type Service struct {
	...
	verificationHistoryMu    sync.RWMutex
	verificationHistoryCache map[int64]VerificationHistoryView
}
...
func NewService(repository Repository) *Service {
	return &Service{
		...
		id:                       randomID,
		verificationHistoryCache: make(map[int64]VerificationHistoryView),
	}
}
