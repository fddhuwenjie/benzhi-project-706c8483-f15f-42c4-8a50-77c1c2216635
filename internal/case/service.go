...
func (s *Service) CreateIncident(input CreateIncidentInput) (*store.EnvironmentIncident, bool, error) {
	return s.CreateIncidentContext(context.Background(), input)
}

func (s *Service) CreateIncidentContext(ctx context.Context, input CreateIncidentInput) (*store.EnvironmentIncident, bool, error) {
	...
	m := store.Mutation{Context: ctx, RequestID: input.Meta.RequestID, Operation: "create_incident", IncidentID: incidentID, ActorID: input.Meta.ActorID, EventType: "incident.reported", Payload: input}
